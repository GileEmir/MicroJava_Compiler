...
public class FormParMore_recursive extends FormParMore {

    private FormPar FormPar;
    private FormParMore FormParMore;

    public FormParMore_recursive (FormPar FormPar, FormParMore FormParMore) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormParMore_recursive(\n");
