...
public class FormParList_recursive extends FormParList {

    private FormPar FormPar;
    private FormParMore FormParMore;

    public FormParList_recursive (FormPar FormPar, FormParMore FormParMore) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("FormParList_recursive(\n");
