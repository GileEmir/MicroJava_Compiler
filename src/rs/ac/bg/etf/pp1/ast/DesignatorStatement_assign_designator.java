...
public class DesignatorStatement_assign_designator extends DesignatorStatement {
    ...
    public DesignatorStatement_assign_designator (Designator Designator, Assignop Assignop, Designator Designator1, Setop Setop, Designator Designator2) {
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("DesignatorStatement_assign_designator(\n");
