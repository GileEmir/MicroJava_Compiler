...
public class VarDeclList_normal extends VarDeclList {

    private Type Type;
    private VarDecl VarDecl;
    private VarDeclMore VarDeclMore;

    public VarDeclList_normal (Type Type, VarDecl VarDecl, VarDeclMore VarDeclMore) {
        this.Type=Type;
    ...
    public String toString(String tab) {
        ...
        buffer.append(tab);
        buffer.append("VarDeclList_normal(\n");
